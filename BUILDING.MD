...
hidden if the `vcpkg-example_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `vcpkg-example_DEVELOPER_MODE` to the configure
